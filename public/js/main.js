...
iconos.forEach((icono) => {
    icono.addEventListener('click', () => {
        ...
        const name = icono.querySelector('.nombre').textContent;  // Corregir aquí
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const documentosConf = [
        {
            enlace: "https://www.youtube.com/embed/fPtuOeVDQZc?si=X86qhd_LOc03Ppgj"
        },
        {
            enlace: "https://www.youtube.com/embed/o_nzfHRi-v4?si=i2x3jZRLh6PzgoB_"
        },
        {
            enlace: "https://www.youtube.com/embed/bXNYXWdvwFA?si=_Xq6QYIvRj3tnWjp"
        }
    ];
